...
import { aboutAuthorTopData } from "../about/aboutAuthor/AboutAthorTopData";

function Contact() {
  return (
    <div className=" my-14 lg:my-24 container">
      <div className="w-full lg:w-[45%] mx-auto mb-10 lg:mb-14">
        <h1 className=" text-theme-black text-center text-[19px] lg:text-[27px]">
          <span className=" bg-theme-parsian-green text-white px-1 mr-3 font-thin text-[19px] lg:text-[27px]">Contact </span> Us
        </h1>
      </div>
      <div className=" flex flex-col lg:flex-row items-start gap-12">
        <form className="w-full lg:w-[50%] space-y-6">
          ...
          <button className=" mb-5 btn2 bg-theme-parsian-green rounded"> Send Message</button>
        </form>
        <div className="w-full lg:w-[30%] ">
          ...
          <p className="mt-8 lg:mt-0 p15 text-theme-gray pt-2">blog.notebook@gmail.com</p>
          <p className=" p15 text-theme-gray pt-2">+88-01864009917</p>
          <p className=" p15 text-theme-gray pt-2 pb-8">Uttara, Dhaka, Bangladesh</p>
